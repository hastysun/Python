...
GallonTimer = simplegui.create_timer(50, GallonInc)
StandardPriceTimer = simplegui.create_timer(50, StandardFuel)
PlusPriceTimer = simplegui.create_timer(50, PlusFuel)
PremiumPriceTimer = simplegui.create_timer(50, PremiumFuel)
...
StandardFuelButton = frame.add_button("Standard - $2.49", StandardFuel, 75)
PlusFuelButton = frame.add_button("Plus - $3.75", PlusFuel, 75)
PremiumFuelButton = frame.add_button("Premium - $4.29", PremiumFuel, 75)

SpacerButton = frame.add_button("", Spacer, 30)

StartButton = frame.add_button("Start", Start, 30)
StopButton = frame.add_button("Stop", Stop, 30)
ResetButton = frame.add_button("Reset", Reset, 30)
